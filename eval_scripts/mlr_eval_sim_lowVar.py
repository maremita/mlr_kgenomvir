...
threshold for virus genome classification of a 
...
if __name__ == "__main__":
    ...
    for iteration in range(1, sim_iter+1):
        ...
        for threshold in thresholds_list:
            ...
            prefix_out = os.path.join(outdir, 
                    "{}_{}_{}_K{}{}_V{}_{}".format(virus_name,
                        evalType, sim_name, tag_kf, klen, threshold,
                        tag_fg))
            ...
            # Add the scores of current threshold to clf_scores
        ...
        outFileSim = os.path.join(outdir,
                "{}_{}_{}_K{}{}_V{}to{}_{}{}{}_A{}_LOWVARS_{}_{}".\
                        format(virus_name, evalType, sim_name, tag_kf,
                            klen, thresholds_list[0], 
                            thresholds_list[-1], tag_fg,
        ...
        if plotResults:
            plot_cv_figure(scores_dfs, score_names, 
                    thresholds_list_str, "Variance threshold",
                    outFileSim)
    ...
    outFile = os.path.join(outdir,
            "{}_{}_sim_K{}{}_V{}to{}_{}{}{}_A{}_LOWVARS_{}_{}".format(
                ...
                thresholds_list[0], thresholds_list[-1], tag_fg,
                mlr_name, str_lr, str_lambda, 
                avrg_metric, eval_metric))
    ...
    if plotResults:
        plot_cv_figure(sim_scores_dfs, score_names,
                thresholds_list_str, "Variance threshold", outFile)
